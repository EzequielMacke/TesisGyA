<!-- filepath: c:\laragon\www\TesisGyA\resources\views\solicitud_materiales\create.blade.php -->
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <title>Nueva Solicitud de Insumos - TesisGyA</title>
    ...
    <div class="main-content">
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div>
                    <h2><i class="fas fa-clipboard-list"></i> Nueva Solicitud de Insumos</h2>
            ...
            <form method="POST" action="{{ route('solicitud_materiales.store') }}" id="solicitudForm">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="destino-toggle">
                                    <label class="destino-check" for="destino_obra">
                                        <input class="form-check-input" type="radio" name="destino_tipo" value="obra" id="destino_obra" {{ old('destino_tipo') == 'obra' ? 'checked' : '' }}>
                                        <span><i class="fas fa-building me-1 text-muted"></i>Obra</span>
                                    </label>
                                    <label class="destino-check" for="destino_deposito">
                                        <input class="form-check-input" type="radio" name="destino_tipo" value="deposito" id="destino_deposito" {{ old('destino_tipo') == 'deposito' ? 'checked' : '' }}>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="observacion" id="observacion" class="form-control form-control-sm" rows="2" placeholder="Ingrese una observación general...">{{ old('observacion') }}</textarea>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Restaurar valores antiguos (old()) tras un error de validación ──
    @if(old('destino_tipo'))
        toggleDestino();
        @if(old('destino_tipo') == 'obra' && old('cliente_id'))
