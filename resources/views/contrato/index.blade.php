        ...
        <div class="content-wrapper">
                        ...
                        <div class="toolbar-grid">
                            ...
                            <div class="toolbar-item toolbar-actions">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('contrato.index') }}" class="btn btn-outline-secondary btn-sm" title="Limpiar filtros">
            ...
            <div class="card table-card">
                <div class="card-header-section">
                    ...
                    <span class="results-count">{{ $contratos->count() }} contrato(s)</span>
                </div>
                    ...
                    <div class="table-container">
                            ...
                            <table id="contratosTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:100px;" class="text-center">Fecha Firma</th>
                                        <th>Usuario</th>
                                ...
                                <tbody>
                                    @foreach($contratos as $contrato)
                                        <tr>
                                            <td class="text-center"><strong>{{ $contrato->id }}</strong></td>
                                            <td>
                                                <span class="cell-text" title="{{ $contrato->cliente->razon_social ?? '-' }}">{{ $contrato->cliente->razon_social ?? '-' }}</span>
                                            </td>
                                            <td>
                                                <span class="cell-text" title="{{ $contrato->obra->descripcion ?? '-' }}">{{ $contrato->obra->descripcion ?? '-' }}</span>
                                            </td>
                                            <td class="text-end">
                                                <span class="amount">₲ {{ number_format($contrato->monto, 0, ',', '.') }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="cell-text" title="{{ $contrato->usuario->usuario ?? '-' }}">{{ $contrato->usuario->usuario ?? '-' }}</span>
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{ route('contrato.show', $contrato->id) }}" class="btn-icon" title="Ver Detalles">
                        ...
                        @else
                            <div class="empty-state">
                                ...
                                <h5 class="text-muted mb-2">No hay contratos registrados</h5>
...
#contratosTable tbody tr:hover { background: #f8fafc; }
#contratosTable tbody tr:last-child td { border-bottom: none; }
