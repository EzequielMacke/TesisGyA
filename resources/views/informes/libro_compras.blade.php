    ...
    <div class="main-content">
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div>
                    <h2><i class="fas fa-book"></i> Informe de Libro de Compras</h2>
            ...
            <div class="card">
                <div class="card-body py-3 px-3">
                    <form method="GET" action="{{ route('informes.libro_compras.pdf') }}" target="_blank">
                        <div class="toolbar-grid">
                            ...
                            <div class="toolbar-item">
                                ...
                                <select name="tipo_documento_id" class="form-select form-select-sm">
                                    <option value="">Todos</option>
