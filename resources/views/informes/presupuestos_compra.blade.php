    ...
    <div class="main-content">
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div>
                    <h2><i class="fas fa-file-invoice-dollar"></i> Informe de Presupuestos de Compra</h2>
            ...
            <div class="card">
                <div class="card-body py-3 px-3">
                    <form method="GET" action="{{ route('informes.presupuestos_compra.pdf') }}" target="_blank">
