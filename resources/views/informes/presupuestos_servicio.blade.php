    ...
    <div class="main-content">
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div>
                    <h2><i class="fas fa-file-invoice-dollar"></i> Informe de Presupuestos de Servicio</h2>
            ...
            <div class="card">
                <div class="card-body py-3 px-3">
                    <form method="GET" action="{{ route('informes.presupuestos_servicio.pdf') }}" target="_blank">
