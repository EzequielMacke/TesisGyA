    ...
    <div class="main-content fade-in">
        ...
        <div class="search-bar mb-3">
            ...
            <span class="search-count">
                <span id="totalRows">{{ $marcas->count() }}</span> registro(s)
            </span>
        </div>
        ...
        <div class="table-card">
            <div class="table-scroll">
                <table class="data-table" id="marcasTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @forelse($marcas as $marca)
                            <tr class="marca-row">
                                <td class="td-id">{{ $marca->id }}</td>
                                <td>{{ $marca->descripcion }}</td>
                                <td class="td-muted">{{ $marca->fecha->format('d/m/Y') }}</td>
                                <td>
                                ...
                                <td class="td-muted">{{ $marca->usuario->usuario }}</td>
                                <td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-clean">
                <div class="modal-header-clean">
                    ...
                    <div>
                        <h5 class="modal-title-clean">Nueva Marca</h5>
                        <p class="modal-sub-clean">Completá los datos para registrar una nueva marca</p>
                    </div>
                    ...
                    <div class="modal-body-clean">
                        <div class="field-group">
                            ...
                            <input type="text"
                                   ...
                                   name="descripcion"
                                   class="field-input"
                                   placeholder="Ej: Weber, Sika, Knauf..."
                                   required
                                   autocomplete="off">
                        </div>
                        <div class="field-group">
                            <label class="field-label" for="crear_fecha">Fecha</label>
                            <input type="date"
                                   id="crear_fecha"
                                   name="fecha"
                                   class="field-input"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-clean">
                <div class="modal-header-clean">
                    ...
                    <div>
                        <h5 class="modal-title-clean">Editar Marca</h5>
                        <p class="modal-sub-clean">Modificá los datos de la marca seleccionada</p>
                    </div>
                    <button type="button" class="modal-close-btn" data-bs-dismiss="modal">
                        <i class="fas fa-times"></i>
                    </button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content modal-clean">
                <div class="modal-header-clean">
                    ...
                    <div>
                        <h5 class="modal-title-clean">Desactivar Marca</h5>
                ...
                <div class="modal-body-clean">
                    <p class="confirm-text">¿Desactivar la marca <strong id="desactivarNombre"></strong>?</p>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content modal-clean">
                <div class="modal-header-clean">
                    ...
                    <div>
                        <h5 class="modal-title-clean">Activar Marca</h5>
                        <p class="modal-sub-clean">La marca volverá a estar disponible</p>
                    </div>
                    <button type="button" class="modal-close-btn" data-bs-dismiss="modal">
                        <i class="fas fa-times"></i>
                    </button>
                ...
                <div class="modal-body-clean">
                    <p class="confirm-text">¿Activar la marca <strong id="activarNombre"></strong>?</p>
                </div>
...
<script>
/* ── Modales de acción ── */
function abrirEditar(id, descripcion, fecha) {
    document.getElementById('formEditar').action = `/marca/${id}`;
...
function abrirDesactivar(id, nombre) {
    document.getElementById('formDesactivar').action = `/marca/${id}`;
...
function abrirActivar(id, nombre) {
    document.getElementById('formActivar').action = `/marca/${id}/activate`;
...
(function() {
    ...
    const rows      = Array.from(table.querySelectorAll('.marca-row'));
    const totalRows = rows.length;

    // Columnas en las que se busca: 0=ID (exacto), 1=Descripción, 3=Estado, 4=Usuario
    const SEARCH_COLS   = [1, 3, 4];   // búsqueda parcial
    const HIGHLIGHT_COL = 1;           // solo resaltar en Descripción

    // Guardar texto original de cada fila una sola vez
    ...
    function filterTable() {
        ...
        cache.forEach(({ cells, texts, origHTML }, i) => {
            ...
            // Restaurar HTML original (quitar resaltados anteriores)
            ...
            // Buscar: ID exacto O coincidencia parcial en columnas definidas
