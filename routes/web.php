...
Route::get('/register',              fn () => view('login.registrar'))->name('register');
Route::get('/confirmar-cuenta',      [LoginController::class, 'confirmarCuenta'])->name('confirmar.cuenta');
Route::get('/verificacion-2fa',      fn (Request $r) => view('login.verificacion', ['email' => $r->email]))->name('verificacion.2fa');
Route::get('/reenviar-codigo',       fn (Request $r) => app(LoginController::class)->reenviarCodigo($r))->name('reenviar.codigo');
Route::get('/manual-usuario',        fn () => view('manual_usuario.manual_user'))->name('manual_usuario.index');
Route::get('/recuperar-contraseña',  fn () => view('login.recuperar_contraseña'))->name('recuperar.contraseña');
...
Route::post('/recuperar-contraseña', [LoginController::class, 'recuperarContraseña']);
...
// ── Rutas autenticadas (solo sesión) ──────────────────────────────────────────
...
Route::middleware('sesion')->group(function () {
    ...
    // ── Marca ─────────────────────────────────────────────────────────────────
    Route::middleware('permiso:mar')->group(function () {
    ...
    // ── Insumos ───────────────────────────────────────────────────────────────
    Route::middleware('permiso:ins')->group(function () {
    ...
    Route::middleware('permiso:sol_ins')->group(function () {
    ...
    Route::middleware('permiso:mov_ins')->group(function () {
    ...
    Route::middleware('permiso:aju_inv')->group(function () {
    ...
    // ── Pedidos de Compra ─────────────────────────────────────────────────────
    Route::middleware('permiso:ped_com')->group(function () {
    ...
    // ── Presupuestar Pedidos (proveedores) ────────────────────────────────────
    Route::middleware('permiso:pre_ped')->group(function () {
    ...
    Route::middleware('permiso:pres_apr')->group(function () {
    ...
    // ── Órdenes de Compra ─────────────────────────────────────────────────────
    Route::middleware('permiso:ord_com')->group(function () {
    ...
    // ── Notas de Remisión ─────────────────────────────────────────────────────
    Route::middleware('permiso:not_rem')->group(function () {
    ...
    // ── Compras (facturas) ────────────────────────────────────────────────────
    Route::middleware('permiso:fac_com')->group(function () {
    ...
    // ── Notas de Compra ───────────────────────────────────────────────────────
    Route::middleware('permiso:not_com')->group(function () {
    ...
    Route::middleware('permiso:sol_ser')->group(function () {
    ...
    // ── Visitas Previas ───────────────────────────────────────────────────────
    Route::middleware('permiso:vis_pre')->group(function () {
    ...
    Route::middleware('permiso:pre_ser')->group(function () {
    ...
    // ── Contratos ─────────────────────────────────────────────────────────────
    Route::middleware('permiso:cont')->group(function () {
    ...
    // ── Órdenes de Servicio ───────────────────────────────────────────────────
    Route::middleware('permiso:ord_ser')->group(function () {
    ...
    // ── Insumos Utilizados ────────────────────────────────────────────────────
    Route::middleware('permiso:ins_uti')->group(function () {
    ...
    Route::middleware('permiso:ser_rea')->group(function () {
    ...
    Route::middleware('permiso:rec_cli')->group(function () {
